...
public class Jeu extends Task<Void> implements IJeu {
     ...
     */
    private ObservableList<CouleurWagon> pileCartesWagon;
    /**
    ...
    public ObservableList<String> traceProperty() {
        return trace;
    }

    public Jeu(String[] nomJoueurs, String[] couleurJoueurs) {
        // initialisation des entrées/sorties
        inputQueue = new LinkedBlockingQueue<>();
        trace = FXCollections.observableArrayList();
        ...
        pileCartesWagon = FXCollections.observableArrayList();
        ...
        for (int i = 0; i<nomJoueurs.length;i++) {
            Joueur j = new Joueur(nomJoueurs[i], this, IJoueur.Couleur.valueOf(couleurJoueurs[i]));
            for (int k = 0; k < 4; k++) {
    ...
    public ObservableList<CouleurWagon> cartesWagonCacheProperty() {
